...
export const HeadingEditor: React.FC<HeadingEditorProps> = ({ task }) => {
    ...
    return (
        <div className="space-y-2">
            ...
            <div className="mt-2 mb-2 pt-4 border-b border-worksheet-border pb-1 print:mt-6 print:mb-2 print:pt-0">
