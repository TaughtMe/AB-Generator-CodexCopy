...
export const SLASH_COMMANDS: SlashCommand[] = [
    ...
    { type: 'matching', label: 'Zuordnung', description: 'Begriffe verbinden / zuordnen', icon: Link2, keywords: ['zuordnung', 'matching', 'verbinden', 'zuordnen', 'paare', 'verbindungslinien'] },
